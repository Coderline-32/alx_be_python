...
match priority:
    case "high":
        if time_bound == "yes":
            ...
            print(f"Reminder: '{task}' is a high priority task. Please make sure to schedule it soon.")
    case "medium":
        if time_bound == "yes":
            print(f"Reminder: '{task}' is a medium priority task that requires attention today.")
        else:
            print(f"Reminder: '{task}' is a medium priority task. Try to do it within the next few days.")
    case "low":
        if time_bound == "yes":
